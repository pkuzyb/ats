...
from ats.layers import HiFiGANResidualBlock as ResidualBlock
from ats.layers import WNConv1d, PastFCEncoder
...
class HiFiGANGenerator(torch.nn.Module):
    ...
    def __init__(
        ...
        if use_ph_loss:
            ...
            self.ph_fc = torch.nn.Linear(channels // (2 ** (i + 1)), num_ph)
            ...
            self.ph_pool = getattr(torch.nn, ph_pooling)(**ph_pooling_params)
    ...
    def forward(self, c, spk_id=None, ar=None, ph=None):
