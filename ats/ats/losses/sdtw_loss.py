...
Based on https://github.com/keonlee9420/Soft-DTW-Loss.
"""
...
class SoftDTW(torch.nn.Module):
    """The soft DTW implementation.

    Only the CUDA version is supported.
    """
    ...
    def _get_func_dtw(self, x, y):
        ...
        if lx > 1024 or ly > 1024:  # We should be able to spawn enough threads in CUDA
    ...
    def forward(self, X, Y):
        ...
        Args:
            X: One batch of examples, (B, C, T).
            Y: The other batch of examples, (B, C, T).
