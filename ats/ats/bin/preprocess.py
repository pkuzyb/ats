...
from ats.datasets import AudioDataset
from ats.datasets import AudioSCPDataset
from ats.datasets import ArtSCPDataset
from ats.utils import write_hdf5
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Preprocess audio and then extract features (See detail in ats/bin/preprocess.py)."
    )
    parser.add_argument(
        "--wav-scp",
        "--scp",
    ...
    # process each data
    for utt_id, tuple in tqdm(dataset):
        audio, fs = tuple
        # check
