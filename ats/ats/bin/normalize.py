...
from ats.datasets import AudioMelDataset
from ats.datasets import AudioMelSCPDataset
from ats.datasets import MelDataset
from ats.datasets import MelSCPDataset
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Normalize dumped raw features (See detail in ats/bin/normalize.py)."
    )
    parser.add_argument(
        "--rootdir",
        default=None,
