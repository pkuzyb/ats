...
from ats.nets.pytorch_backend.e2e_tts_tacotron2 import GuidedAttentionLoss
from ats.nets.pytorch_backend.e2e_tts_tacotron2 import (
    Tacotron2Loss as TransformerLoss,  # noqa: H301
)
from ats.nets.pytorch_backend.nets_utils import make_non_pad_mask
from ats.nets.pytorch_backend.tacotron2.decoder import Postnet
from ats.nets.pytorch_backend.tacotron2.decoder import Prenet as DecoderPrenet
from ats.nets.pytorch_backend.tacotron2.encoder import Encoder as EncoderPrenet
...
from ats.nets.pytorch_backend.transformer.embedding import ScaledPositionalEncoding
...
from ats.nets.tts_interface import TTSInterface
...
try:
    ...
    class TTSPlot(PlotAttentionReport):
        ...
        def plotfn(
            ...
            from ats.nets.pytorch_backend.transformer.plot import (
